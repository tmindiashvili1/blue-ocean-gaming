...
')
     ...
     */ 
         ...
         * 
         *
         * @return \App\Services\XmlService 
         * @throws XmlParseException
         * @static 
         */ 
        public static function parse()
        {
                        /** @var \App\Services\XmlService $instance */
     ...
     *
     */ 
        class SoapServiceFacade {
                    /**
         * 
         *
         * @static 
         */ 
        public static function fetchPeoples()
        {
                        /** @var \App\Services\SoapService $instance */
                        return $instance->fetchPeoples();
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function filterPeople($firstCharacter = 'a')
        {
                        /** @var \App\Services\SoapService $instance */
                        return $instance->filterPeople($firstCharacter);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            class XmlService extends \App\Facades\Services\XmlServiceFacade {}
            class SoapService extends \App\Facades\Services\SoapServiceFacade {}
